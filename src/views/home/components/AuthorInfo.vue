...
<template>
  <div class="card-view hidden animate-zoom-in animate-duration-600 text-center lg:block space-y-5">
    <div class="mt-4 flex justify-center">
      <img class="w-[105px] duration-600 hover:rotate-360" :src="convertImgUrl(userStore.avatar ? userStore.avatar : blogConfig.website_avatar)" alt="author avatar">
    </div>
    <div class="space-y-1">
      <p class="text-2xl">
        {{ userStore.nickname }}
      </p>
      <p> {{ userStore.nickname != null ? userStore.intro : null }} </p>
    </div>
    <!-- 博客信息 -->
